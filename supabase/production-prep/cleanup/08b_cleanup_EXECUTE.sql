-- =========================================================
-- 08b_cleanup_EXECUTE.sql     bobcat-dev test-data cleanup     *** DESTRUCTIVE: ends in COMMIT ***
...
-- ---------------------------------------------------------
commit;
select 'CLEANUP COMMITTED - 225 rows deleted from 26 tables. Next: the Dashboard steps (09_DASHBOARD_STEPS.md), then run 10_post_dashboard_verify_readonly.sql.' as result,
